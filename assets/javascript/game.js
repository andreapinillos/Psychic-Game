window.onload = function () {
  ...
  var alphabetLetters = ['a', 'b', 'c', 'd', 'e', 'f', 'g', 'h',
 	...
 	// Creating variables to hold the number of wins, losses, guess left, and guesses. They start at 0.
    var wins = 0;
    var losses = 0;
    var guessesLeft = 9;
	...
	// make sure that the character user picks is within the alphabet, and not any non-usable character
